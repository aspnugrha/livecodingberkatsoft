    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="card">
                ...
                <small>Date : <b>{{ date('d F Y', strtotime($data['dates']['minimum'])).' - '.date('d F Y', strtotime($data['dates']['maximum'])) }}</b></small>
                <br>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
            <form action="/now_playing/save" method="POST">
                ...
                <div class="form-group">
                    <textarea class="form-control" name="overview" id="overview" cols="30" rows="10" placeholder="Overview" required></textarea>
                </div>
